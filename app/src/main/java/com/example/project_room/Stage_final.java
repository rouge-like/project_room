...
public class Stage_final extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stage_final);
    ...
    public void onInBtn(View view) { //인벤토리 버튼 클릭시
        Intent intent = new Intent(Stage_final.this, Inventory.class);
    ...
    public void onPassWordBtn(View view) { //password button 클릭시 실행
        ...
        if (data.lightoff) { //불이 꺼져있을 경우, 다른 on*Btn 함수와 동일
            ...
            Intent intent = new Intent(Stage_final.this, password.class);
    ...
    public void onNPCBtn(View view) { //npc 클릭시 실행
        ...
        if (data.lightoff) { //불이 꺼져있을 경우, 출력되는 텍스트만 다르고 다른 on**Btn 함수와 동일
            str2.setVisibility(View.VISIBLE);
            ...
            if (s.equals(data.utfHello)) { //이전에 입력했던 s가s가 정답과 일치할 경우
                Intent intent = new Intent(Stage_final.this, npc.class);
